        ...
        <div className='flex flex-col lg:flex-row gap-16'>
            <div className='w-full lgl:w-2/3 text-base text-textDark font-medium flex flex-col gap-4'>
                <p>
                    ...
                    <span className='text-textBlue'> University of North Carolina at Chapel Hill.</span> My interest in programming started back in middle school when I decided I wanted to try building my own video games using C# and Unity. 
